    ...
    <div className="flex flex-col gap-2 mb-4 font-mono">
      ...
      {editField === name ? (
        React.cloneElement(component, {
          ...
          className:
            "bg-black text-white border border-gray-700 rounded-none font-mono",
        })
      ) : (
    ...
    <>
      ...
      <div className="flex min-h-screen bg-black text-white overflow-hidden font-mono">
        ...
        <div className="flex-1 p-6 md:p-8 overflow-y-auto">
          ...
          <div className="bg-gray-900 border border-gray-700 rounded-3xl shadow-2xl p-6 md:p-8">
            ...
            <div className="mt-6 mb-4">
              ...
              <Space className="mt-2">
                ...
                >
                  <Button
                    icon={<UploadOutlined />}
                    className="bg-gray-800 text-white border border-gray-700 rounded-none"
                  >
                    Upload
                  </Button>
                </Upload>
            ...
            <Button
              type="primary"
              onClick={() => updateField({})}
              className="w-full bg-gray-800 border border-gray-700 text-white rounded-none"
            >
              Save Changes
            </Button>
          </div>
