      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 py-20 sm:px-12 lg:px-16">
        ...
        >
          ...
          <h1 className="text-5xl md:text-6xl font-black tracking-tight text-white mb-6 pb-2">
            Algorithm <span className="text-[var(--primary)]">Visualizer Hub</span>
          </h1>
          
          <p className="text-gray-400 text-lg md:text-xl max-w-2xl font-medium leading-relaxed">
            Explore sorting, graphs, trees, recursion and more interactively. Master complex data structures by seeing them run step by step.
          </p>
        </motion.div>
        ...
        >
          <Row gutter={[24, 24]} justify="center">
            {categories.map((cat, index) => (
              <Col xs={24} sm={12} lg={cat.featured ? 16 : 8} xl={cat.featured ? 12 : 6} key={index}>
